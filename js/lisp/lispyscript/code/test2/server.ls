...
(template basePage (pageTitle navBarLinks bodyContent)
  (html {lang:"en"}        ;; <!DOCTYPE html> will be added automatically
    (head
      (title pageTitle)
      ...
      ;; Double quoted strings are multiline
      ;; and you can mix html strings with html templates
      "<!--[if lt IE 9]>
    ...
    (body
      ...
      ;; Load scripts before end of body
      (script {src:"./js/jquery.min.js",type:"text/javascript"})
      (script {type:"text/javascript",src:"./bootstrap/js/bootstrap.js"}))))
;; navBarLinks template
